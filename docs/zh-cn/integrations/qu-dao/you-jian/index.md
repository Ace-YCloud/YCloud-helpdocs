---
doc_id: doc_integrations_qu_dao_you_jian_index
language: zh-CN
title: "邮件"
slug: index
path: integrations/qu-dao/you-jian/index
document_group: integrations
path_in_group: qu-dao/you-jian/index
...
了解邮件的收费标准，请在官网查看价格：[https://www.ycloud.com/en/price](https://www.ycloud.com/en/price)
...
* 试用账号仅支持发送至您自己注册的邮箱。
* 测试每日最大投放量为 50 个。
* YCloud提供了一个地址ycloud@ycloud-mail.com供您测试，但无论您是否升级账户，该地址仅支持发送到您自己的注册邮箱。
