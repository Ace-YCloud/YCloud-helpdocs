---
doc_id: doc_whatsapp_ji_chu_whatsapp_flows_chuang_jian_whatsapp_flows
language: zh-CN
title: "创建WhatsApp Flows"
slug: chuang-jian-whatsapp-flows
path: whatsapp-ji-chu/whatsapp-flows/chuang-jian-whatsapp-flows
document_group: whatsapp-ji-chu
path_in_group: whatsapp-flows/chuang-jian-whatsapp-flows
parent_id: doc_whatsapp_ji_chu_whatsapp_flows
order: 10
status: published
...
1. 确认您是否通过了企业认证。[点击查看申请企业认证详细教程。](../qi-ye-ren-zheng.md)
