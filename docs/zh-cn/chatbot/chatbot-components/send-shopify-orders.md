---
doc_id: doc_chatbot_chatbot_components_send_shopify_orders
language: zh-CN
title: "Send Shopify orders"
slug: send-shopify-orders
path: chatbot/chatbot-components/send-shopify-orders
document_group: chatbot
path_in_group: chatbot-components/send-shopify-orders
