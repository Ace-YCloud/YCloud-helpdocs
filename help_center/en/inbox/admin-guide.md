...
For details, refer to [Creating a Team](../account-management/users-and-teams.md#chuang-jian-tuan-dui)
...
<figure><img src="../.gitbook/assets/image (113) (1).png" alt=""><figcaption><p>Expand or collapse the settings content with the arrow on the right, and turn the function on or off with the switch</p></figcaption></figure>
...
For detailed settings, refer to [Automation](../whatsapp-accounts-management/phone-number-management/automation.md)
...
For detailed guidance, refer to the document: [Inbox Data Analysis](inbox-data-analysis.md)
