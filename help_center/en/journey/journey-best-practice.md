...
* Send time: Contact event \_Customer started Checkout. The contact event needs to be defined and passed to YCloud by you. For details, please refer to "[How to Customize Contact Events.](../contact/contact-settings/contact-event.md)"
