...
See [Copy Code Authentication Templates](copy-verification-code-authentication-template.md) for how to use them.
...
See [One-Tap Autofill Authentication Templates](one-click-autofill-authentication-template.md) for how to use them.
...
See [Zero-Tap Authentication Templates](zero-click-authentication-template.md) for how to use them.
