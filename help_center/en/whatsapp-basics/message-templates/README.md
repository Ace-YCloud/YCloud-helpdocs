...
{% content-ref url="../../whatsapp-accounts-management/template-management/create-template/" %}
[create-template](../../whatsapp-accounts-management/template-management/create-template/)
{% endcontent-ref %}
...
If you believe the template was rejected incorrectly, you can submit a [template appeal](./#mu-ban-shen-su). You can also choose to edit the rejected template and resubmit it.
