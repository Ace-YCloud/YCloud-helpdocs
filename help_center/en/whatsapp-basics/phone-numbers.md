...
{% content-ref url="../whatsapp-accounts-management/create-a-whatsapp-api-account/create-waba-via-embedded-sign-up.md" %}
[create-waba-via-embedded-sign-up.md](../whatsapp-accounts-management/create-a-whatsapp-api-account/create-waba-via-embedded-sign-up.md)
{% endcontent-ref %}

If you already have a WABA, you can add a phone number in the YCloud backend > WhatsApp Account.

{% content-ref url="../whatsapp-accounts-management/create-a-whatsapp-api-account/add-numbers.md" %}
[add-numbers.md](../whatsapp-accounts-management/create-a-whatsapp-api-account/add-numbers.md)
{% endcontent-ref %}
...
* [Migrate a phone number to another WABA](../whatsapp-accounts-management/create-a-whatsapp-api-account/number-migration.md)
...
<figure><img src="../.gitbook/assets/image (769).png" alt=""><figcaption><p>Changing the display name in YCloud</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (770).png" alt=""><figcaption><p>Click Edit to pop up a pop-up window</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (422).png" alt=""><figcaption><p>Phone Number Quality</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (423).png" alt=""><figcaption><p>Phone Number Message Limits</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (425).png" alt="" width="319"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (421).png" alt=""><figcaption><p>Delete Phone Number</p></figcaption></figure>
