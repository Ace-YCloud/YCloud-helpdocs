...
<figure><img src="../../../.gitbook/assets/image (482).png" alt=""><figcaption><p>What are the differences between the sender name, email address, and domain?</p></figcaption></figure>
...
{% content-ref url="email-features/domain-configuration.md" %}
[domain-configuration.md](email-features/domain-configuration.md)
{% endcontent-ref %}
