...
> 📘 [Learn more about different verification channels in the YCloud verification API](verification-channel-selection.md).
...
> 📘 You can [pre-register](../../global-sms/sms-features/sender-id.md) the sender ID for each country/region in YCloud.
