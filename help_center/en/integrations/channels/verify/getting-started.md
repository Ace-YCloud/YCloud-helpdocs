...
If you already have the capability to generate, store, and verify OTPs, you can also use YCloud Verify. For more details, see [Custom OTP](verification-features/custom-otp.md).
...
* [Message Template Configuration](verification-features/verification-message-templates.md): Templates are pre-defined and approved texts for sending verification messages, supported channels include SMS, Voice, WhatsApp, and Email.
* [Security Settings](verification-features/security-settings.md): YCloud's preset security settings, including checking the phone number before starting verification, restricting countries/regions, blacklisting restrictions, etc.
* [Verification Analysis](verification-features/verification-analysis.md): YCloud Verify provides a complete data cycle of verification requests-sending-success, automatically sending verification reports to businesses daily, with clear verification logs for each verification.
