...
{% hint style="info" %}
Before you begin, read this : [TikTok Messaging Ads: Workflow Guide & Prerequisites](./)
{% endhint %}
...
2.  On the TikTok authorization page that opens, log in to your TikTok Ads account.&#x20;
    ...
    <figure><img src="../../.gitbook/assets/tiktok后台-登录tk商业账号-t1.png" alt=""><figcaption></figcaption></figure>
...
* Under the same ad account, each WhatsApp Business number only needs to be linked once. If a number has already been linked to the current ad account, it will be displayed as **Used**. ![](<../../.gitbook/assets/image (28).png>)
