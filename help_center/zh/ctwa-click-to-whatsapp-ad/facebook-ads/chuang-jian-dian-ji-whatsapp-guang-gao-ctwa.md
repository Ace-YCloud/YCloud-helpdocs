...
您还未上传过[转化(Converted)](https://helpdocs.ycloud.com/help-center/zh/ctwa-fen-xi#id-2.-she-zhi-converted)数据。您可以选择其他的Goal进行投放，当回传的转化数据超过10个后，您可以新建或者修改当前广告，修改goal为 “Maximize number of purchases through messaging”
