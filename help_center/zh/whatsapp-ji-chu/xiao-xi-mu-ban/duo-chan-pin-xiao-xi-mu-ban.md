---
description: 本文档介绍了多产品消息 (MPM) 模板、其用途以及如何创建它们。
---
...
MPM 模板可用于开启**营销对话**。它们允许您在一条消息中展示来自电子商务目录的最多 30 种产品（最多分为 10 个部分）。
...
客户可以浏览消息中的产品和部分，查看每个产品的详细信息，在购物车中添加和删除产品，并提交购物车下订单。然后订单会通过 webhook 发送给您。
...
为了创建和使用 MPM 模板，您必须拥有一个包含库存的电子商务产品目录，并将其连接到您的 WhatsApp 商业帐户。
